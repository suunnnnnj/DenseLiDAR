...
def main_worker(rank, world_size, args):
    ...
    def train(image, gt, sparse, pseudo_depth_map, pseudo_gt_map):
        device = 'cuda'
        model.train()
    ...
    def validate(image, gt, sparse, pseudo_depth_map, pseudo_gt_map):
        device = 'cuda'
        model.eval()
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for batch_idx, (image, gt, sparse, pseudo_depth_map, pseudo_gt_map) in tqdm(
            ...
            train_loss, train_s_loss, train_d_loss = train(image, gt, sparse, pseudo_depth_map, pseudo_gt_map)
        ...
        for batch_idx, (image, gt, sparse, pseudo_depth_map, pseudo_gt_map) in tqdm(
            ...
            val_loss, val_s_loss, val_d_loss = validate(image, gt, sparse, pseudo_depth_map, pseudo_gt_map)
        ...
        print('epoch %d structural training loss = %.10f, depth training loss = %.10f' % (epoch, total_val_s_loss / len(ValImgLoader), total_val_d_loss / len(ValImgLoader)))
        print()
