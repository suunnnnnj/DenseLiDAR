...
class myImageFloder(data.Dataset):
    def __init__(self, raw_image, raw_lidar, gt_lidar, pseudo_depth_map, pseduo_gt_map, training,
        ...
        self.pseduo_gt_map = pseduo_gt_map
    ...
    def __getitem__(self, index):
        ...
        pseduo_gt_map = self.pseduo_gt_map[index]
        ...
        pseduo_gt_map = self.ploader(pseduo_gt_map)
        ...
        pseduo_gt_map = pseduo_gt_map[y1:y1 + th, x1:x1 + tw, :]
        ...
        pseduo_gt_map = processed(pseduo_gt_map)
        ...
        return raw_image, gt_lidar, raw_lidar, pseudo_depth_map, pseduo_gt_map
